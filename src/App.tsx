...
function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Navbar onPostAdClick={() => setIsModalOpen(true)} onAuthClick={() => setIsAuthModalOpen(true)} />
      ...
      <AuthModal
        ...
        onLogin={(email) => {
          console.log('Prijava pokrenuta:', email);
          setIsAuthModalOpen(false);
        }}
        onSignup={(name, email) => {
          console.log('Registracija pokrenuta:', name, email);
          setIsAuthModalOpen(false);
        }}
      />
