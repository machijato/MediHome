...
function HomePage() {
  ...
  const filteredProviders = useMemo(() => {
    return providers.filter((p) => {
      ...
      const matchesCounty =
        selectedCounty === "all" || p.location.includes(selectedCounty);
      const matchesSearch =
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto w-full max-w-[1880px] px-4 xl:px-8">
          <div className="xl:grid xl:grid-cols-[160px_minmax(0,1fr)_160px] xl:gap-x-12 2xl:gap-x-16">
            <aside className="hidden xl:block">
              <div className="sticky top-24">
                <div className="w-[160px] h-[600px] rounded-2xl border border-slate-200 bg-white shadow-sm flex items-center justify-center text-xs font-semibold uppercase tracking-wide text-slate-400">
                  Bočni oglas
                </div>
              </div>
            </aside>
            ...
            <div className="min-w-0">
              <section className="relative py-20 overflow-hidden bg-white rounded-[2rem]">
                ...
                <div className="max-w-7xl mx-auto px-4 relative">
                  <div className="max-w-3xl">
                    ...
                    >
                      Povezujemo vas s najboljim fizioterapeutima, medicinskim
                      sestrama i dobavljačima opreme. Brzo, sigurno i pouzdano.
                    </motion.p>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <div className="relative">
                          <select
                            ...
                            onChange={(e) =>
                              setSelectedCounty(e.target.value || "all")
                            }
              ...
              <section className="py-20 bg-white rounded-[2rem]">
                <div className="max-w-7xl mx-auto px-4">
                      ...
                      <div className="max-w-xl text-center md:text-left">
                        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6 leading-tight">
                          ...
                          <span className="text-primary">
                            Postanite dio MediHome tima.
                          </span>
                        </h2>
                        <p className="text-slate-400 text-lg mb-8">
                          Pridružite se tisućama stručnjaka i tvrtki koji već
                          koriste našu platformu za povezivanje s korisnicima.
                          Brza objava, velika vidljivost.
                        </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Vaš partner u pronalaženju najbolje kućne njege i medicinske
                opreme. Povezujemo stručnjake s onima kojima je pomoć
                najpotrebnija.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-slate-100 flex flex-col md:row justify-between items-center gap-4">
            <p className="text-slate-400 text-xs">
              © 2024 MediHome. Sva prava pridržana.
            </p>
