...
export const CategorySection: React.FC<CategorySectionProps> = ({ categories, activeCategory, setActiveCategory }) => {
  return (
              ...
              <div className="p-5 flex-1 flex flex-col">
                <h3
                  className={`text-lg font-bold mb-1 transition-colors ${
                    activeCategory === cat.slug ? 'text-primary' : 'text-slate-900'
                  }`}
                >
                  {cat.name}
                </h3>
                <p className="text-slate-500 text-xs leading-relaxed mb-3">{cat.desc}</p>
