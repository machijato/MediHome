...
export const ArticleSection = () => {
  return (
    <section className="py-20 bg-white" id="novosti">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-end mb-12 gap-4">
          ...
          <a href="/novosti" className="hidden md:flex items-center gap-2 text-primary font-bold hover:underline">
          ...
          {ARTICLES.slice(0, 3).map((article, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                ...
                <Bookmark className="w-4 h-4 text-slate-300 group-hover:text-primary transition-colors" />
              </div>
            </motion.a>
          ))}
        </div>
